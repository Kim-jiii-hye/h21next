...
export default class ViewSubscription1 extends Component {

    componentDidMount() {

        jQuery("#other-team	.title").click(
            function () {
            ...
            <div className="subscription_2">
                ...
                <div className="block	block_0">
                    <div className="block0">
                        <div className="title">
                            <a href="/arti/SUBSCRIPTION/3.html">
                                회원 구독
                            </a>
                        </div>
                        <div className="desc">
                            <a href="/arti/SUBSCRIPTION/3.html">
                                회원이 되면 PDF열람 서비스와 스마트폰/패드로도 &lt;한겨레21&gt;을 볼 수 있습니다.
                            </a>
                        </div>
                    </div>
                </div>
                <div className="block	block_1">
                    <div className="block0">
                        <div className="title">
                            <a href="/arti/SUBSCRIPTION/4.html">
                                비회원 구독
                            </a>
                        </div>
                        <div className="desc">
                            <a href="/arti/SUBSCRIPTION/4.html">
                                비회원 독자도 인터넷&lt;한겨레21&gt;기사를 볼 수 있습니다.
                            </a>
                        </div>
                    </div>
                </div>
                <div className="block	block_2">
                    <div className="block0">
                        <div className="title">
                            <a href="/arti/SUBSCRIPTION/7.html">간편 구독
                            </a>
                        </div>
                        <div className="desc">
                            <a href="/arti/SUBSCRIPTION/7.html" >
                                이름, 전화번호, 이메일만 알려주시면 간편하게 구독신청을 하실수 있습니다.
                            </a>
                        </div>
                    </div>
                </div>
                <div className="block	block_3">
                    <div className="block0">
                        <div className="title">
                            ...
                            <a href="/arti/SUBSCRIPTION/6.html">
                                연장 구독
                            </a>
                        </div>
                        <div className="desc">
                            <a href="/arti/SUBSCRIPTION/6.html">
                                정기구독 만료 전에 손쉽게 구독 연장을 하실 수 있습니다.
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="block	block_5">
                    <div className="block0">
                        <div className="title">
                            <a href="/arti/SUBSCRIPTION/5.html">
                                해외 구독
                            </a>
                        </div>
                        <div className="desc">
                            <a href="/arti/SUBSCRIPTION/5.html">
                                해외에서도 인터넷&lt;한겨레21&gt;기사를 만나 보실 수 있습니다.
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div id="other-team" className="closed">
                    <h5 className="title">해외 정기구독 안내
                        <span className="open"><img src="//img.hani.co.kr/section-image/15/h21/image/arrow_down_box.png" alt="닫기" title="닫기" /></span>
