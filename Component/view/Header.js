			...
			<div className="header0">
				<div className="header1">
					<div className="header2">
						<div id="fb-root"></div>
						<ul className="sns">
							<li className="facebook"><div className="fb-like" data-href="https://www.facebook.com/hankyoreh21" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</li>
						</ul>
