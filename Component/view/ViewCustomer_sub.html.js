...
export default function ViewCustomer_sub() {
    const {
        state: {
            config_url: { SVC_PATH }
        }
            ...
            <div className="contents0">
                <div className="menu">
                    <ul className="menu1">
                        ...
                        <li><a href="//notice.hani.co.kr/h21/opinion" target="popwin_share">독자문의</a><span
                            className="split">|</span></li>
                        <li><a href="//notice.hani.co.kr/" target="_blank">한겨레 고객센터</a></li>
                    </ul>
                </div>
                <div className="contents1">
                    <div className="customer_1">
                        ...
                        <div className="answer">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="col0">북미(캐나다),유럽,중동 및 아시아 일부(아프카니스탄,인도,파키스탄,스리랑카,네팔
                                            등)
                                        </td>
                                        <td className="col1">130,000원</td>
                                    ...
                                    <tr>
                                        <td className="col0">대양주(오스트레일리아(호주),뉴질랜드,파파뉴기니,괌,사이판
                                            등),아프리카,중남미,서인도제도,남태평양제도
                                        </td>
                                        <td className="col1">130,000원</td>
                        ...
                        <div className="answer">
                            ...
                            또는 이메일 <a href="mailto:p-dokja@hani.co.kr"><span
                                className="link2">P-DOKJA@HANI.CO.KR</span></a>,
                            <a href="//magazine21.hani.co.kr/requestorg/gudok_request.jsp"
                                target="_blank"><span className="link2">온라인사이트</span></a>에서 신청 가능합니다.
                        </div>
                        <div className="question">
                            낱권은 어디서 구매할 수 있나요?
                        </div>
                        <div className="answer">
                            ...
                            <br />
                            <div className="link1">
                                <a href="http://www.bandinlunis.com/search/search.do?q=%C7%D1%B0%DC%B7%B921"
                                    target="_blank">
                                    <img src={`${SVC_PATH}/image/customer/logo_bandi.png`} alt="반디앤루니스"
                                        title="반디앤루니스" />
                                </a>
                                <span className="split">
                                    <img src={`${SVC_PATH}/image/customer/split.png`} alt="}" />
                                </span>
                                <a href="http://www.aladin.co.kr/search/wsearchresult.aspx?SearchTarget=All&SearchWord=%C7%D1%B0%DC%B7%B921&SortOrder=5"
                                    target="_blank">
                                    <img src={`${SVC_PATH}/image/customer/logo_aladin.png`} alt="알라딘"
                                        title="알라딘" />
                                </a>
                                <span className="split">
                                    <img src={`${SVC_PATH}/image/customer/split.png`} alt="}" />
                                </span>
                                <a href="http://bsearch.interpark.com/dsearch/book.jsp?query=%C7%D1%B0%DC%B7%B921"
                                    target="_blank">
                                    <img src={`${SVC_PATH}/image/customer/logo_interpark.png`}
                                        alt="인터파크" title="인터파크" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="answer">
                            02-710-0544로 연락해 발행호수와 필요한 부수 재고를 먼저 확인 후 구매하실 수 있습니다. 본사로 직접 방문해 구매하시거나
                            온라인으로 입금해 우편으로 받아 보실 수 있습니다.
                        </div>
                        <div className="question">
                        ...
                        <div className="answer">
                            ...
                            우체국 배송은 2014년 9월부터 전국 우체국의 토요휴무제 전면 시행으로 토요일에서 부득이하게 월요일 새벽에 접수하는 것으로
                            변경되었습니다.
                            ...
                            <div className="delivery">
                                <img src={`${SVC_PATH}/image/customer/delivery.png`} alt="우체국 배송 흐름"
                                    title="우체국 배송 흐름" />
                            </div>
                        </div>
                        <div className="question">
                        ...
                        <div className="answer">
                            <a href="http://contribute.hani.co.kr/input/h21_opinion_2015.hani"
                                target="popwin_share"><span
                                    className="link2">홈페이지</span></a> 또는
                            해당 <Link href="/arti/INTRODUCTION/1.html"><span
                                className="link2">기자의 전자우편</span></Link>으로 제보하실 수 있습니다.<br />
                        </div>
                        <div className="question">
                            지면 PDF를 보고 싶습니다. 어디서 확인할 수 있을까요?
                        </div>
                        <div className="answer">
                            <a href="http://h21pdf.hani.co.kr/PaperList.aspx" target="_blank"><span
                                className="link2">PDF 보기</span></a>에서 확인할 수 있습니다.
                        ...
                        <div className="answer">
                            <Link href="/arti/SUBSCRIPTION/1.html"><span className="link2">홈페이지</span></Link>에서
                            구독자 성함과 지역으로 검색해서 인증할 수 있습니다.
                            또한 정기구독자 인증을 위해선 인터넷한겨레 온라인 회원으로 먼저 가입이 되어있어야 합니다.<br /><br />
                            ※ 홈페이지에서 정기구독자 성함과 지역으로 검색해 일치하는 독자를 선택하고 전화승인을 요청하시면 고객센터에 입력된 전화번호와 일치하면
                            자동승인 처리됩니다.
