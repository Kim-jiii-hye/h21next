...
export default function ViewCustomer_home() {
	return (
			...
			<div className="contents0">
				<div className="contents1">
					<div className="item	item_0">
						<div className="item0">
							<div className="title">
								<Link href="/arti/CUSTOMER/sub.html"><a><strong>자주하는</strong> 질문<span className="small">(FAQ)</span></a></Link>
							</div>
							<div className="desc">
						...
						<div className="item0">
							<div className="title">
								<a href="http://contribute.hani.co.kr/input/h21_opinion_2015.hani"><strong>독자</strong>문의</a>
							</div>
							<div className="desc">
						...
						<div className="item0">
							<div className="title">
								<a href="//notice.hani.co.kr" target="_blank"><strong>한겨레</strong>고객센터</a>
							</div>
							<div className="desc">
